    ...
    return (
        <div className='container'>
            ...
            <div className='coupon'>
                <div><p>Click and Collect is now available at Hong Kong stores. Enjoy complimentary shipping on orders over HK$400 </p></div>
...
{/* <svg aria-labelledby="aesop-40" class="Icon_base__GKZ58 Icon_light__1TZsq Logo_icon__NDEf8" data-testid="data-testid-Icon" focusable="false" height="40" role="txt" tabindex="-1" viewBox="0 0 489.7 154.3" width="120" style={{ height: "40px", width: "120px", color: "white" }}>
        <g>
